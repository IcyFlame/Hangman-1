...
var collection = [
    ...
    IPL = {
        ...
        'words': ['RAJASTHAN ROYALS','CHENNAI SUPER KINGS','MUMBAI INDIANS','DELHI DAREDEVILS','KINGS XI PUNJAB','KOLKATA KNIGHT RIDERS','MUMBAI INDIANS','PUNE WARRIORS INDIA','SUNRISERS HYDERABAD'],
        'group': 'Name of an IPL team'
    ...
    Novels = {
        ...
        'words': ['ULYSSES','THE GREAT GATSBY','LOLITA','THE LORD OF THE RINGS','BRAVE NEW WORLD','THE SOUND AND THE FURY','DARKNESS AT NOON','SONS AND LOVERS','THE GRAPES OF WRATH','UNDER THE VOLCANO','THE WAY OF ALL FLESH','TO KILL A MOCKINGBIRD','MISSION EARTH','GONE WITH THE WIND','THE AGE OF INNOCENCE','HEART OF DARKNESS','A FAREWELL TO ARMS','ANGLE OF REPOSE','LOVING','TOBACCO ROAD'],
        'group': 'Name of a novel'
    },

    Cplayers = {

        'words': ['MAHENDRA SINGH DHONI','MICHAEL HUSSY','RAVINDRA JADEJA','MURALI VIJAY','DWAYNE BRAVO','CHRIS MORRIS','SURESH RAINA','RICKY PONTING','AIDEN BLIZZARD','HARBHAJAN SINGH','LASITH MALINGA','GLENN MAXWELL','DWAYNE SMITH','ROHIT SHARMA','JAMES FRANKLIN','PHILIP HUGHES','MITCHELL JOHNSON','KIERON POLLARD','SACHIN TENDULKAR','VIRAT KHOLI','DANIEL CHRISTIAN','TILAKARATNE DILSHAN','CHRIS GAYLE','KUMAR SANGAKKARA','NATHAN MCCULLUM','CAMERON WHITE','ANGELO MATHEWS','WAYNE PARNELL','YUVRAJ SINGH','MAHELA JAYAWARDENE','VIRENDRA SHEWAG','DAVID WARNER','UNMUKT CHAND','IRFAN PATHAN','GAUTAM GAMBHIR','BRETT LEE','YUSUF PATHAN','ADAM GILCHRIST','DAVID MILLER','DAVID HUSSEY','RAHUL DRAVID','BRAD HOGG','AJINKYA RAHANE','SHANE WATSON','BRAD HODGE','SHAHID AFRIDI','HASHIM AMLA'],
        'group': 'Name of a Cricket Player'

    },

    continent = {

        'words': ['AFRICA','EUROPE','ASIA','NORTH AMERICA','SOUTH AMERICA','ANTARCTICA','AUSTRALIA'],
        'group': 'Name of a Continent'

    },

    band = {

        'words': ['RAGE AGAINST THE MACHINE','METALLICA','RADIOHEAD','THE BEATLES','LED ZEPPELIN','PINK FLOYD','NIRVANA','IRON MAIDEN','RED HOT CHILI PEPPERS','SYSTEM OF A DOWN','THE CLASH','PANTERA','BLACK SABBATH','LAMB OF GOD','THE DOORS','TOOL','QUEENS OF THE STONE AGE','THE WHO','THE ROLLING STONES','LINKIN PARK' ],
        'group': 'Name of a Musical Band'
...
$(document).ready(function () {
	...
	this.setAttribute("style","background-color:rgb(255,0,0)"); //once a letter is guessed it is highlighted in red.
        hideIt(this.value);
